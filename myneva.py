...
socat  pty,link=/dev/virtualcom0,raw  tcp:192.168.100.202:8899
Может возникнуть путаница из-за некорректного выставления параметров протокола, непосредственно со счетчиком должны быть параметры 7Е1, в конвертере интерфейсов 8N1
