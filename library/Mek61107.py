...
class Mek61107:
    ...
    class Command(Message):
        def __init__(self, command, data, is_block: bool = False):
    ...
    def parse(self, buff):
        ...
        # find ETX or EOT
        end_index: int = buff.find('\x03')  # ETX
        if end_index < 0:
    ...
    def is_bcc_correct(self, buff, end_index, start_index=1):
        ...
        return ord(buff[end_index + 1]) == self.calculate_bcc_iso1155(buff[start_index:end_index + 1])
